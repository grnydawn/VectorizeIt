...
c
      ...
      double precision a(n), b(n), c(n), d(n), e(n), aa(ld,n),
     +                 bb(ld,n), cc(ld,n)
      double precision chksum, cs2d, array
      real t1, t2, second, ctime, dtime
      parameter(nn=1000)
      common /cdata/ array(nn*nn)
...
c
      ...
      double precision a(n), b(n), c(n), d(n), e(n), aa(ld,n),
     +                 bb(ld,n), cc(ld,n)
      double precision chksum, cs1d, s1, s2
      real t1, t2, second, ctime, dtime
...
c
      ...
      double precision a(n), b(n), c(n), d(n), e(n), aa(ld,n),
     +                 bb(ld,n), cc(ld,n)
      double precision chksum, cs1d, s
      real t1, t2, second, ctime, dtime
...
c
      ...
      double precision a(n), b(n), c(n), d(n), e(n), aa(ld,n),
     +                 bb(ld,n), cc(ld,n)
      double precision chksum, cs1d, s, t
      real t1, t2, second, ctime, dtime
...
c
      ...
      double precision a(n), b(n), c(n), d(n), e(n), aa(ld,n),
     +                 bb(ld,n), cc(ld,n)
      double precision chksum, cs1d, x
      real t1, t2, second, ctime, dtime
...
c
      ...
      double precision a(n), b(n), c(n), d(n), e(n), aa(ld,n),
     +                 bb(ld,n), cc(ld,n)
      double precision chksum, cs1d, x, y
      real t1, t2, second, ctime, dtime
...
c
      ...
      double precision a(n), b(n), c(n), d(n), e(n), aa(ld,n),
     +                 bb(ld,n), cc(ld,n)
      double precision chksum, cs1d, t
      real t1, t2, second, ctime, dtime
...
c    
     ...
     +                 bb(ld,n), cc(ld,n)
      ...
      do 1 nl = 1,ntimes
      do 10 i=1,n
         if (b(i) .gt. 0.d0) a(i) = a(i) + b(i) * c(i)
   10 continue
      call dummy(ld,n,a,b,c,d,e,aa,bb,cc,1.d0)
   1  continue
      t2 = second() - t1 - ctime - ( dtime * float(ntimes) )
...
c
     ...
     +                 bb(ld,n), cc(ld,n)
      ...
      do 10 i = 1 , n
         a(i) = a(i) + d(i) * e(i)
         if (a(i) .lt. 0.d0) b(i) = b(i) + d(i) * e(i)
         c(i) = c(i) + a(i) * d(i)
   10 continue
      call dummy(ld,n,a,b,c,d,e,aa,bb,cc,1.d0)
   1  continue
...
c
     ...
     +                 bb(ld,n), cc(ld,n)
      ...
      do 1 nl = 1,ntimes
      do 10 i = 1,n
         if(b(i) .ne. 0.d0) a(i) = a(i) + b(i) * c(i)
  10  continue
      call dummy(ld,n,a,b,c,d,e,aa,bb,cc,1.d0)
  1   continue
      t2 = second() - t1 - ctime - ( dtime * float(ntimes) )
...
c
      ...
      double precision a(n), b(n), c(n), d(n), e(n), aa(ld,n),
     +                 bb(ld,n), cc(ld,n)
      double precision chksum, q, factor
      real t1, t2, second, ctime, dtime
      parameter(factor=.99999d0)
...
c
  ...
  20     continue
  10  continue
      chksum = max + dble(xindex) + dble(yindex)
      call dummy(ld,n,a,b,c,d,e,aa,bb,cc,chksum)
  1   continue
      t2 = second() - t1 - ctime - ( dtime * float(ntimes/n) )
      chksum = max + dble(xindex) + dble(yindex)
...
c
      ...
      double precision a(n), b(n), c(n), d(n), e(n), aa(ld,n),
     +                 bb(ld,n), cc(ld,n)
      double precision chksum, cs1d, sum
      real t1, t2, second, ctime, dtime
...
c
      ...
      double precision a(n), b(n), c(n), d(n), e(n), aa(ld,n),
     +                 bb(ld,n), cc(ld,n)
      double precision chksum, t, value
      real t1, t2, second, ctime, dtime
...
c
      ...
      double precision a(n), b(n), c(n), d(n), e(n), aa(ld,n),
     +                 bb(ld,n), cc(ld,n)
      double precision chksum, alpha, cs1d
      real t1, t2, second, ctime, dtime
...
c
     ...
     +                 bb(ld,n), cc(ld,n)
      ...
      do 10 i = 1,n-1
         x(i) = y(i+1) + a(i)
  10  continue
      call dummy(ld,n,x,b,c,d,e,aa,bb,cc,1.d0)
  1   continue
      t2 = second() - t1 - ctime - ( dtime * float(ntimes) )
      chksum = cs1d(n,x)
...
c
      ...
      double precision a(n), b(n), c(n), d(n), e(n), aa(ld,n),
     +                 bb(ld,n), cc(ld,n)
      double precision chksum, cs1d, x(nn)
      real t1, t2, second, ctime, dtime, c471s
...
c
      ...
      double precision a(n), b(n), c(n), d(n), e(n), aa(ld,n),
     +                 bb(ld,n), cc(ld,n)
      double precision chksum, cs1d, f, x, y
      real t1, t2, second, ctime, dtime
      f(x,y) = x*y
...
c
     ...
     +                 bb(ld,n), cc(ld,n)
      double precision chksum, cs1d
      double precision a1, b1, c1, d1, e1, f1, s(nn)
      real t1, t2, second, ctime, dtime
